...
export class ImageTransition1Sketch {
    ...
    constructor(container: HTMLElement) {
        ...
        const assets: Promise<any>[] = [
            new FileLoader().loadAsync(
                'assets/image-transition-1/_fragment.glsl'
            ),
            new FileLoader().loadAsync(
                'assets/image-transition-1/_vertex.glsl'
            ),
    ...
    private init(): void {
        ...
        this.uniforms = {
            ...
            u_t1Aspect: {
                type: 'v2',
                value: this.getCoverAspectRatio(this.fromT, this.container)
            },
            u_t2Aspect: {
                type: 'v2',
                value: this.getCoverAspectRatio(this.toT, this.container)
            }
        };
    ...
    public updateSize(): void {
        ...
        this.uniforms.u_t2Aspect.value = this.getCoverAspectRatio(
            this.toT,
            this.container
        );
        this.camera.aspect =
