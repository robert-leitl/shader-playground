...
export class MouseDistortionSketch {
    ...
    constructor(container: HTMLElement) {
        ...
        const assets: Promise<any>[] = [
            new FileLoader().loadAsync(
                'assets/mouse-distortion-1/_fragment.glsl'
            ),
            new FileLoader().loadAsync(
                'assets/mouse-distortion-1/_vertex.glsl'
            ),
    ...
    public animate(): void {
        ...
        this.mouseVelocity.x +=
            (this.mousePos.x - this.mouseTracker.x - this.mouseVelocity.x) /
            1.5;
        this.mouseVelocity.y +=
            (this.mousePos.y - this.mouseTracker.y - this.mouseVelocity.y) /
            1.5;
