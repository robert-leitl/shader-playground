...
export class MouseDistortion1Component implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.sketch = new MouseDistortionSketch(this.hostElementRef.nativeElement);
    this.sketch.oninit = () => {
